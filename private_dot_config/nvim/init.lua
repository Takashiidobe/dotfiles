...
require("lazy").setup({
  ...
  -- treesitter
  {
    ...
    build = ':TSUpdate',
    config = function()
      -- custom lean parser; on the main branch this must be registered in a User TSUpdate autocmd
      ...
      -- main has no auto_install; list parsers explicitly.
      -- capnp and yaml were previously pulled in by auto_install (manual start / yaml.nvim)
      require('nvim-treesitter').install({ 'rust', 'lua', 'toml', 'lean', 'capnp', 'yaml' })
    end,
  },
  -- testing
  {
